    ...
    try {
      ...
      for (const [accId, list] of grouped) {
        ...
        agingList.push({
          ...
          customerPhone2: customer.phone_2 || '',
          customerPhone3: customer.phone_3 || '',
          customerPhone4: customer.phone_4 || '',
        ...
        <div className="aging-modal-overlay" onClick={closeModal}>
          <div className="aging-modal-content aging-modal-detail" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="aging-modal-body">
              ...
              {/* ============================================ */}
              {/* ✅ ACCOUNT SUMMARY WITH ADVANCE AMOUNT + 4 PHONES */}
              {/* ============================================ */}
              <div className="detail-summary" style={{ 
                ...
                <div className="detail-summary-item" style={{ background: '#f8f9fc', padding: '12px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                  ...
                  <strong style={{ fontWeight: 600, display: 'block' }}>
                    ...
                    {selectedCustomer.customerPhone2 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{selectedCustomer.customerPhone2}</span>}
                    {selectedCustomer.customerPhone3 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{selectedCustomer.customerPhone3}</span>}
                    {selectedCustomer.customerPhone4 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{selectedCustomer.customerPhone4}</span>}
                  </strong>
                </div>
                <div className="detail-summary-item" style={{ background: '#f8f9fc', padding: '12px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
              ...
              <div className="aging-documents-section" style={{ marginTop: '20px', borderTop: '2px solid #e5e7eb', paddingTop: '20px' }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  {selectedCustomer.customer?.voice_consent_2 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_2)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_3 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_3)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_4 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_4)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_5 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_5)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_6 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_6)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_7 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_7)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_8 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_8)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_9 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_9)} />
                    </audio>
                  )}
                  {selectedCustomer.customer?.voice_consent_10 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedCustomer.customer.voice_consent_10)} />
                    </audio>
                  )}
                  {!selectedCustomer.customer?.voice_consent && !selectedCustomer.customer?.voice_consent_2 && 
                   !selectedCustomer.customer?.voice_consent_3 && !selectedCustomer.customer?.voice_consent_4 && 
                   !selectedCustomer.customer?.voice_consent_5 && !selectedCustomer.customer?.voice_consent_6 && 
                   !selectedCustomer.customer?.voice_consent_7 && !selectedCustomer.customer?.voice_consent_8 && 
                   !selectedCustomer.customer?.voice_consent_9 && !selectedCustomer.customer?.voice_consent_10 && (
                    <p style={{ color: '#6b7280', fontSize: '14px', margin: 0 }}>No voice consent files found</p>
                  )}
                </div>
