...
// ============================================
// ✅ VIEW MODAL WITH SLIP NO + ADVANCE AMOUNT + 4 PHONES + 10 VOICE FILES
// ============================================
const ViewModal = ({ 
  selectedInstallment, 
  showModal, 
          ...
          <div className="modal-body">
              ...
              <div className="info-grid">
                ...
                <div className="info-item">
                  ...
                  <span className="info-value">
                    ...
                    {customer.phone_2 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{customer.phone_2}</span>}
                    {customer.phone_3 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{customer.phone_3}</span>}
                    {customer.phone_4 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{customer.phone_4}</span>}
                  </span>
                </div>
                <div className="info-item">
            ...
            <div className="modal-section">
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                {customer.voice_consent_2 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_2)} />
                  </audio>
                )}
                {customer.voice_consent_3 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_3)} />
                  </audio>
                )}
                {customer.voice_consent_4 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_4)} />
                  </audio>
                )}
                {customer.voice_consent_5 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_5)} />
                  </audio>
                )}
                {customer.voice_consent_6 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_6)} />
                  </audio>
                )}
                {customer.voice_consent_7 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_7)} />
                  </audio>
                )}
                {customer.voice_consent_8 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_8)} />
                  </audio>
                )}
                {customer.voice_consent_9 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_9)} />
                  </audio>
                )}
                {customer.voice_consent_10 && (
                  <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                    <source src={getFileUrl(customer.voice_consent_10)} />
                  </audio>
                )}
                {!customer.voice_consent && !customer.voice_consent_2 && !customer.voice_consent_3 && 
                 !customer.voice_consent_4 && !customer.voice_consent_5 && !customer.voice_consent_6 && 
                 !customer.voice_consent_7 && !customer.voice_consent_8 && !customer.voice_consent_9 && 
                 !customer.voice_consent_10 && (
                  <p className="no-data">No voice consent files found</p>
                )}
              </div>
...
const Installments = () => {
  ...
  // ============================================
  // ✅ EXPORT DATA — WITH ADVANCE AMOUNT
  // ============================================
  const exportData = useMemo(() => {
    return filteredInstallments.map(item => {
      ...
      return {
        ...
        advanceAmount: Math.round(parseFloat(account.advance_amount || 0)), // ✅ ADDED
  ...
  // ============================================
  // ✅ EXPORT COLUMNS — WITH ADVANCE PAYMENT
  // ============================================
  const exportColumns = [
            ...
            <table className="installments-table">
              <thead>
                <tr style={{ background: '#1E1B4B' }}>
                  {selectMode && (
                    <th style={{ width: '40px', fontWeight: 800, color: '#fff', padding: '14px 16px', textAlign: 'center', borderBottom: 'none' }}></th>
                  )}
              ...
              <tbody>
                {currentItems.map((item, index) => {
                  ...
                  const advanceAmount = accountData.advance_amount || 0;
