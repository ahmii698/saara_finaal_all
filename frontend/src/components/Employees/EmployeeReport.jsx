...
const EmployeeReport = () => {
  ...
  // ✅ MOVED UP — Year/Month filters ke helper functions (getMonthKeysForFilter wagera)
                ...
                displayEmployees.map((emp, index) => {
                  ...
                  return (
                    <tr key={emp.id} className={index % 2 === 0 ? 'even-row' : 'odd-row'}>
                      ...
                      {/* ✅ FIXED: Target column - Red when accounts = 0 */}
                      <td>
                        {stats.targetsAvailable && stats.target > 0 ? (
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                            <span style={{ 
                              fontWeight: 800, 
                              color: stats.accounts === 0 ? '#dc2626' : '#C9A84C' 
                            }}>
                            ...
                            <span style={{ 
                              fontSize: '0.7rem', 
                              fontWeight: 700, 
                              color: stats.progress >= 100 ? '#22c55e' : stats.accounts === 0 ? '#dc2626' : '#6b7280' 
                            }}>
                              {stats.progress}%
                            </span>
                          </div>
