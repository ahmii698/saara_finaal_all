            ...
            <div className="oi-modal-body">
              ...
              <div className="oi-detail-grid" style={{ 
                ...
                <div className="oi-detail-item" style={{ background: '#f8f9fc', padding: '12px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
                  ...
                  <strong style={{ fontWeight: 600, display: 'block' }}>
                    {selectedRecord.customerPhone || 'N/A'}
                    {selectedRecord.customerPhone2 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{selectedRecord.customerPhone2}</span>}
                    {selectedRecord.customerPhone3 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{selectedRecord.customerPhone3}</span>}
                    {selectedRecord.customerPhone4 && <span style={{display: 'block', fontSize: '12px', color: '#6b7280'}}>{selectedRecord.customerPhone4}</span>}
                  </strong>
                </div>
                <div className="oi-detail-item" style={{ background: '#f8f9fc', padding: '12px', borderRadius: '8px', border: '1px solid #e5e7eb' }}>
              ...
              <div className="oi-documents-section" style={{ marginTop: '20px', borderTop: '2px solid #e5e7eb', paddingTop: '20px' }}>
                ...
                <div style={{ marginBottom: '20px' }}>
                  ...
                  {selectedRecord.customer?.voice_consent_2 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_2)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_3 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_3)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_4 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_4)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_5 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_5)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_6 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_6)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_7 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_7)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_8 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_8)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_9 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_9)} />
                    </audio>
                  )}
                  {selectedRecord.customer?.voice_consent_10 && (
                    <audio controls preload="none" style={{ width: '100%', marginBottom: '8px' }}>
                      <source src={getFileUrl(selectedRecord.customer.voice_consent_10)} />
                    </audio>
                  )}
                  {!selectedRecord.customer?.voice_consent && !selectedRecord.customer?.voice_consent_2 && 
                   !selectedRecord.customer?.voice_consent_3 && !selectedRecord.customer?.voice_consent_4 && 
                   !selectedRecord.customer?.voice_consent_5 && !selectedRecord.customer?.voice_consent_6 && 
                   !selectedRecord.customer?.voice_consent_7 && !selectedRecord.customer?.voice_consent_8 && 
                   !selectedRecord.customer?.voice_consent_9 && !selectedRecord.customer?.voice_consent_10 && (
