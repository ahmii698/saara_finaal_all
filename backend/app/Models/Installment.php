...
class Installment extends Model
{
    ...
    // ✅ NEW: 'advance_amount' add kiya gaya hai advance payment track karne ke liye
    protected $fillable = [
        'account_id', 'month', 'due_date', 'due_amount', 'paid_amount', 'slip_no',
        'balance', 'advance_amount', 'status', 'payment_date', 'description', 'remarks'
    ];
    ...
    // ============================================
    // ✅ NEW: Get formatted advance amount
    // ============================================
    public function getFormattedAdvanceAmount()
    {
        return number_format($this->advance_amount ?? 0, 2);
    }
    ...
    // ============================================
    // ✅ NEW: Get payment summary with slip_no and advance
    // ============================================
    public function getPaymentSummaryAttribute()
    {
        return [
            ...
            'advance_amount' => $this->getFormattedAdvanceAmount(),
