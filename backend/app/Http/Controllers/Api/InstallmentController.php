...
class InstallmentController extends Controller
{
    ...
    // ============================================
    // ✅ UPDATED: PARTIAL PAY WITH LEDGER-BASED ADVANCE
    // ============================================
        ...
        try {
            ...
            if ($amount <= 0) {
                ...
                return response()->json([
                    ...
                    'advance_amount' => $installment->advance_amount ?? 0,
            ...
            // ✅ Update installment - advance_amount ab per-installment excess se nahi
            $installment->update([
                'paid_amount' => $newPaidAmount,
                'balance' => $newBalance,
                'status' => $status,
                ...
                'remarks' => $request->remarks ?? $installment->remarks,
                'slip_no' => $request->slip_no ?? $installment->slip_no,
                // advance_amount ab per-installment nahi save karenge
                // ledger-based calculation account level par hogi
            ]);
            ...
            if ($account) {
                ...
                // ✅ FIX: Ledger-based advance — due_date <= aaj wale installments
                // "consume" hote hain, baaki jo bhi paid hai wo advance hai
                $ledgerAdvance = $account->calculateLedgerAdvance();
                ...
                $account->update([
                    ...
                    'last_payment_date' => $paymentDate,
                    'status' => $newAccountBalance <= 0 ? 'paid' : 'active',
                    'advance_amount' => $ledgerAdvance, // ✅ LEDGER-BASED ADVANCE
                ]);
            }
            ...
            return response()->json([
                ...
                'advance_amount' => $ledgerAdvance ?? 0, // ✅ LEDGER-BASED ADVANCE
                'status' => $status
            ]);
    ...
    public function agingReport(Request $request)
    {
        ...
        $data = $installments->map(function($item) use ($today) {
            ...
            return [
                ...
                'account' => [
                    ...
                    'advance_amount' => $item->account->advance_amount ?? 0,
        ...
        $summary = [
            ...
            'total_advance' => $data->sum('advance_amount'),
    ...
    public function getStats(Request $request)
    {
        ...
        $stats = [
            ...
            'total_advance' => (clone $query)->sum('advance_amount'),
        ];
