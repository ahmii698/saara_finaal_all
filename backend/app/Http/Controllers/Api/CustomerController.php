...
class CustomerController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $validator = Validator::make($request->all(), [
                ...
                'voice_consent_5' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:20480',
                'voice_consent_6' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:20480',
                'voice_consent_7' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:20480',
                'voice_consent_8' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:20480',
                'voice_consent_9' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:20480',
                'voice_consent_10' => 'nullable|file|mimes:mp3,wav,m4a,ogg,webm|max:20480',
            ]);
            ...
            // ✅ Voice Consent — ab 10 tak, loop se handle
            $voiceConsentPaths = [
                'voice_consent' => null,
                'voice_consent_2' => null,
                'voice_consent_3' => null,
                'voice_consent_4' => null,
                'voice_consent_5' => null,
                'voice_consent_6' => null,
                'voice_consent_7' => null,
                'voice_consent_8' => null,
                'voice_consent_9' => null,
                'voice_consent_10' => null,
            ];
            ...
            try {
                ...
                $customer = Customer::create([
                    ...
                    'voice_consent_5' => $voiceConsentPaths['voice_consent_5'],
                    'voice_consent_6' => $voiceConsentPaths['voice_consent_6'],
                    'voice_consent_7' => $voiceConsentPaths['voice_consent_7'],
                    'voice_consent_8' => $voiceConsentPaths['voice_consent_8'],
                    'voice_consent_9' => $voiceConsentPaths['voice_consent_9'],
                    'voice_consent_10' => $voiceConsentPaths['voice_consent_10'],
    ...
    public function update(Request $request, $id)
    {
        ...
        $replaceFile('voice_consent_5', 'customers/voice', 'voice_consent_5');
        $replaceFile('voice_consent_6', 'customers/voice', 'voice_consent_6');
        $replaceFile('voice_consent_7', 'customers/voice', 'voice_consent_7');
        $replaceFile('voice_consent_8', 'customers/voice', 'voice_consent_8');
        $replaceFile('voice_consent_9', 'customers/voice', 'voice_consent_9');
        $replaceFile('voice_consent_10', 'customers/voice', 'voice_consent_10');
